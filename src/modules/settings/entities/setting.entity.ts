...
export class Setting {
  ...
  @ApiProperty({
    ...
    example: {
      ...
      schedule: {
        monday: { opening: '09:00', closing: '22:00', closed: false },
        tuesday: { opening: '09:00', closing: '22:00', closed: false },
        wednesday: { opening: '09:00', closing: '22:00', closed: false },
        thursday: { opening: '09:00', closing: '22:00', closed: false },
        friday: { opening: '09:00', closing: '23:00', closed: false },
        saturday: { opening: '10:00', closing: '23:00', closed: false },
        sunday: { opening: '10:00', closing: '21:00', closed: true },
      },
    },
    type: 'object',
    additionalProperties: true,
